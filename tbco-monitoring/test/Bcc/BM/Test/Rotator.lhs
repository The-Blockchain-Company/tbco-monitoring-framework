...
\subsection{Rotator}
\label{code:Bcc.BM.Test.Rotator}
...
#ifdef POSIX
import           Bcc.BM.Rotator (nameLogFile, cleanupRotator, listLogFiles, tsformat)
import           Bcc.BM.Data.Rotation (RotationParameters (..))
#else
import           Bcc.BM.Rotator (nameLogFile)
#endif

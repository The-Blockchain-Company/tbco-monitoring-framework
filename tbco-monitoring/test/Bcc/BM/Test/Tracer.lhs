...
\subsection{Bcc.BM.Test.Tracer}
\label{code:Bcc.BM.Test.Tracer}
...
import           Bcc.BM.Configuration.Model (setSubTrace)
import           Bcc.BM.Internal.ElidingTracer
import           Bcc.BM.Data.Aggregated (Measurable(PureI))
...
import           Bcc.BM.Trace (Trace, appendName, traceNamedObject)

...
\subsection{Bcc.BM.Test.Structured}
\label{code:Bcc.BM.Test.Structured}
...
import           Bcc.BM.Test.Mock (MockSwitchboard (..))
import           Bcc.BM.Test.Trace (TraceConfiguration (..), setupTrace)

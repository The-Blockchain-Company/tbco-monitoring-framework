...
\subsection{Bcc.BM.Test.Trace}
\label{code:Bcc.BM.Test.Trace}
...
import           Bcc.BM.Configuration (Configuration, evalFilters,
                     inspectSeverity, minSeverity, setMinSeverity, setSeverity)
import           Bcc.BM.Configuration.Model (empty, setDefaultBackends,
                     setDefaultScribes, setSubTrace, setSetupBackends,
                     setSetupScribes)
import           Bcc.BM.Configuration.Static
import           Bcc.BM.Data.BackendKind (BackendKind (..))
...
#ifdef ENABLE_OBSERVABLES
import           Bcc.BM.Counters (getMonoClock, readCounters)
import           Bcc.BM.Data.Aggregated
import           Bcc.BM.Data.Counter
import qualified Bcc.BM.Observer.Monadic as MonadicObserver
import qualified Bcc.BM.Observer.STM as STMObserver
#endif
import qualified Bcc.BM.Setup as Setup
import           Bcc.BM.Trace (Trace, appendName, logDebug, logInfo,
                     logInfoS, logNotice, logWarning, logError, logCritical,
                     logAlert, logEmergency)
import           Bcc.BM.Test.Mock (MockSwitchboard (..), traceMock)

import           Bcc.BM.Arbitrary ()
...
unitTraceMinSeverity = do
    ...
    msev <- Bcc.BM.Configuration.minSeverity cfg
...
unitNamedMinSeverity = do
    ...
    msev <- Bcc.BM.Configuration.inspectSeverity cfg "test-named-severity.sev-change"
...
unitHierarchy' subtraces f = do
    cfg <- liftIO Bcc.BM.Configuration.Model.empty

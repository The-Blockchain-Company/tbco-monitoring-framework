...
\subsection{Bcc.BM.Configuration.Model}
\label{code:Bcc.BM.Configuration.Model}
...
module Bcc.BM.Configuration.Model
    ( Configuration (..)
...
import qualified Bcc.BM.Data.Configuration as R
import           Bcc.BM.Data.Configuration (RemoteAddr(..), RemoteAddrNamed(..))
import           Bcc.BM.Data.LogItem (LogObject (..), LoggerName, LOContent (..), severity)
import           Bcc.BM.Data.MonitoringEval (MEvExpr, MEvPreCond, MEvAction)
import           Bcc.BM.Data.Output (ScribeDefinition (..), ScribeId,
                     ScribeKind (..))
import           Bcc.BM.Data.Rotation (RotationParameters (..))

...
\subsection{Bcc.BM.Data.LogItem}
\label{code:Bcc.BM.Data.LogItem}
...
import           Bcc.BM.Data.Aggregated (Aggregated (..), Measurable (..))
...
under SimM of shardagnostic-network because ThreadId from Control.Concurrent lacks a Read
instance.
\begin{code}
data LOMeta = LOMeta {

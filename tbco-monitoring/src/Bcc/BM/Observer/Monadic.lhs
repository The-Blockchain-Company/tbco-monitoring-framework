...
\subsection{Bcc.BM.Observer.Monadic}
\label{code:Bcc.BM.Observer.Monadic}
...
module Bcc.BM.Observer.Monadic
    (
      bracketObserveIO
    , bracketObserveM
    , bracketObserveX
...
import           Bcc.BM.Data.Counter (CounterState (..), diffCounters)
import           Bcc.BM.Data.LogItem (LOContent (..), LOMeta,
...
import           Bcc.BM.Data.SubTrace (SubTrace (Neutral, NoTrace))
import           Bcc.BM.Trace (Trace, traceNamedObject)
\end{code}
%endif

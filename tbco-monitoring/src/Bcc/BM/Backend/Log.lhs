...
\subsection{Bcc.BM.Backend.Log}
\label{code:Bcc.BM.Backend.Log}
...
import           Bcc.BM.Configuration.Model (getScribes, getSetupScribes)
...
import           Bcc.BM.Rotator (cleanupRotator, evalRotator,

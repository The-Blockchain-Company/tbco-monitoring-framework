\subsection{Bcc.BM.Backend.LogBuffer}
\label{module:Bcc.BM.Backend.LogBuffer}
...
module Bcc.BM.Backend.LogBuffer
    ( LogBuffer
    , readBuffer
    , effectuate
    , realize
...
import           Bcc.BM.Data.Backend (BackendKind (LogBufferBK),
                     IsBackend (..), IsEffectuator (..))
import           Bcc.BM.Data.LogItem (LOContent (..), LoggerName,
                     LogObject (..))

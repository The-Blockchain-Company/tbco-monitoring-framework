...
\subsection{Bcc.BM.Backend.Graylog}
\label{code:Bcc.BM.Backend.Graylog}
...
import           Bcc.BM.Configuration (Configuration, getGraylogPort)
...
plugin config trace sb = do
    be :: Bcc.BM.Backend.Graylog.Graylog a <- realizefrom config trace sb

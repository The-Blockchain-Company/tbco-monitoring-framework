...
\title{Bcc.BM - logging, benchmarking and monitoring}
...
Please see |Bcc.BM.Data.LogItem| for more details.
...
editor (see |Bcc.BM.Configuration.Editor| for more details).
...
log items (e.g. last, min, max, mean) (see |Bcc.BM.Data.Aggregated|).
...
(further behaviour types are implemented in |Bcc.BM.Data.SubTrace|)
...
\section{Code listings - tbco-monitoring package}


%include ../tbco-monitoring/src/Bcc/BM/Observer/STM.lhs
%include ../tbco-monitoring/src/Bcc/BM/Observer/Monadic.lhs

%include ../tbco-monitoring/src/Bcc/BM/Trace.lhs

%include ../tbco-monitoring/src/Bcc/BM/Setup.lhs

%include ../tbco-monitoring/src/Bcc/BM/Counters.lhs
%include ../tbco-monitoring/src/Bcc/BM/Counters/Common.lhs
%include ../tbco-monitoring/src/Bcc/BM/Counters/Dummy.lhs
%include ../tbco-monitoring/src/Bcc/BM/Counters/Linux.lhs

%include ../tbco-monitoring/src/Bcc/BM/Data/Aggregated.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/AggregatedKind.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Backend.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/BackendKind.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Configuration.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Counter.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/LogItem.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Observable.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Output.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Rotation.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Severity.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/SubTrace.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Trace.lhs
%include ../tbco-monitoring/src/Bcc/BM/Data/Tracer.lhs

%include ../tbco-monitoring/src/Bcc/BM/Configuration.lhs
%include ../tbco-monitoring/src/Bcc/BM/Configuration/Model.lhs
%include ../tbco-monitoring/src/Bcc/BM/Configuration/Static.lhs

%include ../tbco-monitoring/src/Bcc/BM/Backend/Switchboard.lhs
%include ../tbco-monitoring/src/Bcc/BM/Backend/Log.lhs
%include ../tbco-monitoring/src/Bcc/BM/Backend/LogBuffer.lhs
%include ../plugins/backend-ekg/src/Bcc/BM/Backend/EKGView.lhs
%include ../plugins/backend-editor/src/Bcc/BM/Backend/Editor.lhs
%include ../plugins/backend-graylog/src/Bcc/BM/Backend/Graylog.lhs
%include ../plugins/backend-aggregation/src/Bcc/BM/Backend/Aggregation.lhs
%include ../plugins/backend-monitoring/src/Bcc/BM/Backend/Monitoring.lhs
%include ../plugins/backend-prometheus/src/Bcc/BM/Backend/Prometheus.lhs
%include ../tbco-monitoring/src/Bcc/BM/Backend/ExternalAbstraction.lhs
%include ../tbco-monitoring/src/Bcc/BM/Backend/TraceAcceptor.lhs
%include ../tbco-monitoring/src/Bcc/BM/Backend/TraceForwarder.lhs

\chapter{Testing}

%include ../tbco-monitoring/test/Test.lhs
